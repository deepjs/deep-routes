...
for .route()  et getRoute()
> : from childs : so all struct has to be mounted 
...
define(["require", "deepjs/deep", "./route"], function(require, deep)
{
    ...
    var createRouteNode = deep.utils.createRouteNode = function (parent, rest, mapper, entryNode, root){
        return  {
