    ...
    deep.RouteNode.prototype =   {
        ...
        getRoute:function(route, fromChilds, asArray){
            ...
            var printRouteNode = function(m, output){
                ...
                if(m.childs)
                    m.childs.forEach(function(e){ printRouteNode(e, output); });
            };
            if(!route)
            {
                if(this.root)
                ...
                var output = [];
                this.childs.forEach(function(e){ printRouteNode(e, output); });
                if(asArray)
                    return output;
                return "/"+output.join("/");
            }
            ...
            switch(cur)
            {
                ...
                case "." :          // local
                    ...
                    if(this.root)
                        ...
                        childs = this.childs;
                    childs.forEach(function(e){ printRouteNode(e, routeOutput); });
